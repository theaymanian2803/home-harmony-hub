        ...
        <div className="mx-auto max-w-4xl rounded-3xl gradient-chocolate p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Button
                size="lg"
                className="gradient-caramel text-accent-foreground hover:opacity-90 rounded-xl px-10 text-base shadow-lg"
                asChild
              >
                <Link to="/pricing">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-caramel/40 bg-transparent text-caramel hover:bg-caramel hover:text-accent-foreground rounded-xl px-10"
                asChild
              >
