...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
      ...
      {/* Small floating neumorphic shapes */}
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <h1 className="mt-8 font-display text-5xl font-extrabold leading-[1.05] tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          Find Your
          <span className="text-gradient-chocolate block mt-2">Dream Home</span>
        </h1>
        ...
        <div
          className="mx-auto mt-12 max-w-3xl animate-fade-in-up neu-card-lg p-6 md:p-8"
        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center">
            ...
            <Button
              size="lg"
              className="gradient-caramel text-accent-foreground hover:opacity-90 rounded-xl px-8 shadow-lg"
        ...
        {/* Trust badges as neumorphic pills */}
